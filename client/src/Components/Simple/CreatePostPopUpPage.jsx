...
import { useGetPagePost } from "../../customHooks/useGetPageData";
import Loader from "./Loader";

const CreatePostPopUpGroupPage = ({ setStatus, privacy = true }) => {
  const { groupName, pageName } = useParams();
  const postImgRef = useRef(null);
  const { dataPagePosts, isLoadingPagePosts, refetchPagePosts } =
  ...
  if (isLoadingPagePosts) return <Loader />;
...
export default CreatePostPopUpGroupPage;
